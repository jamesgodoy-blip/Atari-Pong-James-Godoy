...
Para este proyecto, se selecciono la librería `pygame` debido a su robustez en el manejo de gráficos 2D. Sin embargo, durante el desarrollo se identificó una complejidad técnica: la incompatibilidad actual de Pygame con las versiones más recientes de Python (3.13+). 
